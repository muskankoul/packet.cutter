...
public class Packet{
  ...
  */
    public Packet(String fileName,String filePath,String preLocation){
    try{
   ...
   /*
   * This method assist Packet constructor in moving bytes from source file into target file
